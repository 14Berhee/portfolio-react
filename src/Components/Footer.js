      ...
      <div>
        ...
        <div>
          <div className="flex justify-center gap-5 items-center mb-4">
            <img className="w-8 h-8" src="mail.jpg"></img>
            <h1 className="w-80 text-[36px] font-semibold">Berhee14@gmail.com</h1>
            <img className="ml-10 w-8 h-8" src="copy.png"></img>
          </div>

          <div className="flex justify-center gap-5 items-center mb-12">
            <img className="w-8 h-8" src="Phone.jpg"></img>
            <h1 className="w-72 text-[36px] font-semibold">+976 94029797</h1>
            <img className="w-8 h-8" src="copy.png"></img>
          </div>
        </div>
